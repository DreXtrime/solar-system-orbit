export const planetData = {
    earth: {
        ...
        description:
            'The only known planet to harbour life, Earth is a dynamic world of liquid oceans, shifting tectonic plates, and a protective magnetic field. From space it glows vivid blue, the colour of the water covering 71% of its surface.',
        stats: [
            {
                label: 'Diameter',
                value: '12,742 km',
                comparison:
                    'If Earth were hollow, you could fit 49 Moons inside it',
            },
            {
                label: 'Distance from Sun',
                value: '149.6 million km',
                comparison:
                    'A plane flying non-stop would take 17 years to get there',
            },
            {
                label: 'Year length',
                value: '365.25 days',
                comparison: "You've lapped the Sun as many times as your age",
            },
            {
                label: 'Surface temp',
                value: '15°C avg',
                comparison:
                    'The goldilocks zone — warm enough for liquid water',
            },
            {
                label: 'Image',
                value: 'December 7 1972',
                comparison: '"The Blue Marble From Apollo 17"',
            },
        ],
        facts: [
    ...
    mercury: {
        ...
        description:
            'The smallest planet and closest to the Sun, Mercury is a battered, cratered world with no atmosphere to protect it. Temperatures swing wildly — hotter than an oven by day, colder than Antarctica by night.',
        stats: [
            {
                label: 'Diameter',
                value: '4,879 km',
                comparison: 'Slightly wider than the continental United States',
            },
            {
                label: 'Distance from Sun',
                value: '57.9 million km',
                comparison:
                    'About a third of the distance from Earth to the Sun',
            },
            {
                label: 'Year length',
                value: '88 days',
                comparison:
                    'Four Mercury years pass in the time of one Earth year',
            },
            {
                label: 'Surface temp',
                value: '-180°C to 430°C',
                comparison:
                    'Swings more than any other planet — no atmosphere to even it out',
            },
            {
                label: 'Image',
                value: 'October 6 2008',
                comparison:
                    "minutes before NASA's MESSENGER spacecraft made its closest approach to Mercury",
            },
        ],
        facts: [
    ...
    venus: {
        ...
        description:
            "Venus is Earth's twisted twin — similar in size but a scorching hellscape beneath thick clouds of sulphuric acid. A day on Venus is longer than its year, and the Sun rises in the west.",
        stats: [
            {
                label: 'Diameter',
                value: '12,104 km',
                comparison: 'Almost exactly the same size as Earth',
            },
            {
                label: 'Distance from Sun',
                value: '108.2 million km',
                comparison: "About 70% of Earth's distance from the Sun",
            },
            {
                label: 'Year length',
                value: '225 days',
                comparison:
                    'But a single day lasts 243 Earth days — longer than its year',
            },
            {
                label: 'Surface temp',
                value: '465°C avg',
                comparison:
                    'Hot enough to melt lead — hotter than Mercury despite being further away',
            },
            {
                label: 'Image',
                value: 'Feb 9. 1979',
                comparison:
                    "Venus in Ultraviolet Light From NASA's Pioneer Venus Orbiter",
            },
        ],
        facts: [
    ...
    mars: {
        ...
        description:
            "The red planet is a cold, dusty desert with the tallest volcano and longest canyon in the solar system. Mars has seasons, polar ice caps, and a day almost identical to Earth's — making it humanity's most likely next home.",
        stats: [
            {
                label: 'Diameter',
                value: '6,779 km',
                comparison: 'About half the width of Earth',
            },
            {
                label: 'Distance from Sun',
                value: '227.9 million km',
                comparison:
                    'One and a half times further from the Sun than Earth',
            },
            {
                label: 'Year length',
                value: '687 days',
                comparison: 'Nearly two Earth years for one lap around the Sun',
            },
            {
                label: 'Surface temp',
                value: '-60°C avg',
                comparison: 'Similar to winter in Antarctica',
            },
            {
                label: 'Image',
                value: 'February 25, 2007',
                comparison:
                    "European Space Agency's (ESA) Rosetta spacecraft executed a critical gravity assist flyby of Mars",
            },
        ],
        facts: [
    ...
    jupiter: {
        ...
        description:
            'Jupiter is a giant ball of gas so massive it could swallow all other planets combined. Its Great Red Spot is a storm that has been raging for over 350 years, wider than Earth itself.',
        stats: [
            {
                label: 'Diameter',
                value: '139,820 km',
                comparison:
                    '11 Earths lined up side by side would stretch across it',
            },
            {
                label: 'Distance from Sun',
                value: '778.5 million km',
                comparison: 'Over 5 times further from the Sun than Earth',
            },
            {
                label: 'Year length',
                value: '12 Earth years',
                comparison:
                    'A child born today would be 12 before Jupiter finishes one lap',
            },
            {
                label: 'Moons',
                value: '95 known moons',
                comparison:
                    'More moons than any other planet — four are larger than our Moon',
            },
            {
                label: 'Image',
                value: 'Dec. 3, 1974',
                comparison:
                    'Pioneer 11 was the second spacecraft to observe Jupiter close up. The spacecraft’s closest approach to Jupiter, at a range of about 42,500 kilometer from the planet’s cloud tops',
            },
        ],
        facts: [
    ...
    saturn: {
        ...
        description:
            "Saturn's iconic rings are made of billions of chunks of ice and rock, stretching 282,000 km wide but only about 10 metres thick. Despite being enormous, Saturn is so light it would float in water.",
        stats: [
            {
                label: 'Diameter',
                value: '116,460 km',
                comparison: "Nine Earths could fit across Saturn's equator",
            },
            {
                label: 'Distance from Sun',
                value: '1.43 billion km',
                comparison:
                    'Light takes 80 minutes to travel from the Sun to Saturn',
            },
            {
                label: 'Year length',
                value: '29 Earth years',
                comparison:
                    'Most adults have only seen Saturn complete one orbit in their lifetime',
            },
            {
                label: 'Ring width',
                value: '282,000 km',
                comparison:
                    'The rings are wider than the distance from Earth to the Moon',
            },
            {
                label: 'Image',
                value: 'Nov. 3, 1980',
    ...
    uranus: {
        ...
        description:
            "Uranus rolls around the Sun on its side, spinning at a 98-degree tilt — likely the result of a massive collision billions of years ago. It's an icy blue-green world so cold it holds the record for the lowest temperature of any planet.",
        stats: [
            {
                label: 'Diameter',
                value: '50,724 km',
                comparison: 'Four Earths would fit side by side across Uranus',
            },
            {
                label: 'Distance from Sun',
                value: '2.87 billion km',
                comparison:
                    'Light takes over 2.5 hours to reach it from the Sun',
            },
            {
                label: 'Year length',
                value: '84 Earth years',
                comparison:
                    'Most people will never live to see Uranus complete a full orbit',
            },
            {
                label: 'Surface temp',
                value: '-224°C',
                comparison:
                    'The coldest planetary temperature in the solar system',
            },
            {
                label: 'Image',
                value: 'January 24, 1986',
                comparison:
    ...
    neptune: {
        ...
        description:
            'Neptune is the windiest place in the solar system, with storms reaching 2,100 km/h. So far from the Sun that it took 165 years after its discovery to complete just one orbit, it was the first planet found through mathematical prediction rather than observation.',
        stats: [
            {
                label: 'Diameter',
                value: '49,244 km',
                comparison: 'Nearly four times wider than Earth',
            },
            {
                label: 'Distance from Sun',
                value: '4.5 billion km',
                comparison:
                    'Light takes over 4 hours to make the journey from the Sun',
            },
            {
                label: 'Year length',
            ...
            },
            {
                ...
                value: '2,100 km/h',
                comparison:
                    'Six times faster than the strongest hurricanes on Earth',
            },
            {
                label: 'Image',
                value: 'October 30, 1998',
                comparison:
                    "This picture of Neptune was produced from the last whole planet images taken through the green and orange filters on NASA's Voyager 2 narrow angle camera. The images were taken at a range of 7.1 million miles from the planet, 4 days and 20 hours before closest approach.",
            },
        ],
        facts: [
    ...
    sun: {
        ...
        description:
            'The Sun is the star at the heart of our solar system, accounting for 99.86% of all its mass. It has been burning for 4.6 billion years and has enough fuel left to last another 5 billion — at which point it will expand into a red giant and swallow the inner planets.',
        stats: [
            {
                label: 'Diameter',
                value: '1.39 million km',
                comparison: '109 Earths lined up would stretch across it',
            },
            {
                label: 'Distance from Earth',
                value: '149.6 million km',
                comparison: 'A plane would take 17 years to fly there non-stop',
            },
            {
                label: 'Surface temp',
                value: '5,500°C',
                comparison:
                    'Hot enough to vaporise any known material instantly',
            },
            {
                label: 'Age',
                value: '4.6 billion years',
                comparison:
                    "If Earth's history were a calendar year, humans appear in the last 10 minutes",
            },
            {
                label: 'Image',
                value: 'June 20, 2013, at 11:15 p.m',
                comparison:
                    'EDT shows the bright light of a solar flare on the left side of the sun and an eruption of solar material shooting through the sun’s atmosphere, called a prominence eruption. Shortly thereafter, this same region of the sun sent a coronal mass ejection out into space.',
            },
        ],
        facts: [
    ...
    pluto: {
        ...
        description:
            "Once considered the ninth planet, Pluto was reclassified as a dwarf planet in 2006 — a decision that still sparks debate. It's a surprisingly complex world with mountains of water ice, a heart-shaped nitrogen plain, and a thin atmosphere that freezes and falls as snow.",
        stats: [
            {
                label: 'Diameter',
                value: '2,377 km',
                comparison:
                    'You could fit Pluto inside Australia with room to spare',
            },
            {
                label: 'Distance from Sun',
                value: '5.9 billion km',
                comparison: 'Light takes over 5 hours to reach it from the Sun',
            },
            {
                label: 'Year length',
                value: '248 Earth years',
                comparison:
                    "Pluto hasn't completed a single orbit since it was discovered in 1930",
            },
            {
                label: 'Surface temp',
                value: '-230°C',
                comparison:
                    'Just 43 degrees above absolute zero — the coldest possible temperature',
            },
            {
                label: 'Image',
                value: 'July 13, 2015',
                comparison:
                    "Pluto nearly fills the frame in this image from NASA's New Horizons spacecraft, when the spacecraft was 768,000 kilometers from the surface. This is the last and most detailed image sent to Earth before the spacecraft's closest approach to Pluto on July 14. ",
            },
        ],
        facts: [
